...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TransfertCashFragment(), "Virement");
        adapter.addFragment(new HistoryListFragment(), "Historique");
        adapter.addFragment(new RechargeCashFragment(), "Rechargement");
